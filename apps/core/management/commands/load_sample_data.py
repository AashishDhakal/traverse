        ...
        sites_data = [
            {
                ...
                "config": {
                    ...
                    "hero_title": "Traverse The Himalayas",
                    "hero_subtitle": "Expert-led adventures through Nepal's most iconic mountain ranges. From Everest Base Camp to Annapurna Circuit.",
                    "hero_cta_text": "Explore Trips",
                    "footer_description": "Nepal's premier adventure travel company offering authentic Himalayan experiences since 2010.",
                    "title_suffix": " | Traverse The Himalayas",
                },
            },
            {
                ...
                "config": {
                    ...
                    "hero_title": "Book Direct. Save More.",
                    "hero_subtitle": "Skip the middleman and book directly with local Nepali experts. Guaranteed best prices on all treks.",
                    "hero_cta_text": "Find Your Trek",
                    "footer_description": "Your direct connection to authentic Nepal adventures. No middlemen, no markups.",
                    "title_suffix": " | VisitNepalDirect",
                },
            },
            {
                ...
                "config": {
                    ...
                    "hero_title": "Luxury Himalayan Escapes",
                    "hero_subtitle": "Experience Nepal's majesty in uncompromising comfort. Private guides, premium lodges, helicopter transfers.",
                    "hero_cta_text": "View Experiences",
                    "footer_description": "Curating the finest luxury adventure experiences in the Himalayas for discerning travelers.",
                    "title_suffix": " | NepalLuxe",
                },
            },
            {
                ...
                "config": {
                    ...
                    "hero_title": "Adventure Awaits",
                    "hero_subtitle": "Epic Himalayan adventures that won't break the bank. Backpacker-friendly treks starting from $30/day.",
                    "hero_cta_text": "See Budget Treks",
                    "footer_description": "Making the Himalayas accessible to every adventurer, regardless of budget.",
                    "title_suffix": " | BudgetHimalaya",
                },
            },
        ]
    ...
    def _create_trips(self):
        ...
        trips_data = [
            ...
            # Helicopter Tours
            {
                ...
                "tagline": "Fly to Everest Base Camp in style",
                "overview": "Experience the thrill of flying to Everest Base Camp and Kalapatthar in a helicopter. Witness breathtaking views of the world's highest peaks without the trek.",
                "detailed_itinerary": "<h2>Itinerary</h2><p>Early morning departure from Kathmandu. Scenic flight along the Himalayan range. Landing at Kalapatthar (5,545m) for photos. Optional landing at Everest Base Camp. Return to Kathmandu by midday.</p>",
                "duration_days": 1,
                "max_altitude": 5545,
                "difficulty": "easy",
                "price": 1299,
                "trip_type": "helicopter",
                "flight_duration_minutes": 180,
                "landing_sites": "Kalapatthar, Everest Base Camp",
            ...
            },
            {
                ...
                "tagline": "Fly into the heart of Annapurna",
                "overview": "A spectacular helicopter flight to Annapurna Base Camp, landing amidst the stunning amphitheater of Himalayan giants. Perfect for those short on time.",
                "detailed_itinerary": "<h2>Itinerary</h2><p>Depart Pokhara early morning. Fly over lush valleys and glaciers. Land at Annapurna Base Camp (4,130m). Enjoy the mountain views before returning to Pokhara.</p>",
                "duration_days": 1,
                "max_altitude": 4130,
                "difficulty": "easy",
                "price": 899,
                ...
                "landing_sites": "Annapurna Base Camp",
                "helicopter_capacity": 5,
            ...
            },
            {
                ...
                "slug": "langtang-valley-helicopter-tour",
                "tagline": "Discover the valley of glaciers from above",
                "overview": "Explore the beautiful Langtang Valley from a helicopter. Fly over earthquake-affected areas that have been rebuilt and witness stunning glacier views.",
                "detailed_itinerary": "<h2>Itinerary</h2><p>Depart Kathmandu. Fly over Langtang National Park. Land at Kyanjin Gompa (3,870m). Explore the area and enjoy mountain views. Return to Kathmandu.</p>",
                "duration_days": 1,
                "max_altitude": 3870,
                "difficulty": "easy",
                "price": 799,
